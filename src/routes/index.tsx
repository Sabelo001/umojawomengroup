...
import academyImage from "@/assets/umojaschool.webp.asset.json";
import campsiteRiverside from "@/assets/campsite-riverside.asset.json";
import beadwork from "@/assets/beadwork.asset.json";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Umoja Women Group | Samburu Community, Culture & Campsite" },
      { name: "description", content: "A women-led Samburu community in Archer's Post, Kenya, sharing culture, education, beadwork, hospitality, and the Umoja Campsite experience." },
      { property: "og:title", content: "Umoja Women Group | Samburu Community, Culture & Campsite" },
      { property: "og:description", content: "A women-led Samburu community in Archer's Post, Kenya, sharing culture, education, beadwork, hospitality, and the Umoja Campsite experience." },
    ],
...
function Home() {
  return (
    <Layout>
      {/* HERO */}
      <section className="image-fill-polish-wrap relative min-h-[88vh] md:min-h-[92vh] flex items-end overflow-hidden bg-charcoal">
        <SafeImage src={womenWalking.url} alt="Samburu women walking together near Umoja village" className="image-fill-polish absolute inset-0 w-full h-full object-cover" loading="eager" fetchPriority="high" />
        ...
        <div className="relative container-narrow pb-16 md:pb-24 pt-32 text-cream">
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.08] max-w-4xl">
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            <a href="https://wa.me/254721659717?text=Hello%20Umoja%2C%20I%27d%20like%20to%20plan%20a%20visit." target="_blank" rel="noopener noreferrer" className="inline-flex min-h-11 w-full sm:w-auto items-center justify-center gap-2 bg-primary text-primary-foreground px-7 py-3.5 rounded-full hover:bg-primary/90 transition font-medium">
              Visit Umoja <ArrowRight className="w-4 h-4" />
            </a>
            <Link to="/support" className="inline-flex min-h-11 w-full sm:w-auto items-center justify-center gap-2 border border-cream/40 text-cream px-7 py-3.5 rounded-full hover:bg-cream/10 transition">
              Support the work
            </Link>
          </div>
        </div>
      ...
      <section className="container-narrow pb-20 md:pb-28">
        <div className="grid md:grid-cols-3 gap-5 md:gap-6">
          {[
            ...
            { icon: Tent, title: "Umoja Campsite & visitor experience", body: "Cottages, camping and cultural visits along the Ewaso Nyiro river." },
        ...
        <div className="container-narrow py-20 md:py-28 grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          <div>
            ...
            <p className="text-foreground/80 text-lg leading-relaxed mb-8">
              Umoja Muehlbauer Academy gives children from Umoja and the surrounding settlements a safe place to learn, eat and grow, supported by the women who built this community.
            </p>
            <Link to="/academy" className="inline-flex items-center gap-2 text-primary font-medium border-b border-primary/40 pb-1 hover:border-primary">
              Discover Umoja Muehlbauer Academy <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
          <div className="image-polish relative aspect-[4/5] rounded-2xl overflow-hidden bg-sand">
            <SafeImage src={academyImage.url} alt="Umoja Muehlbauer Academy building" className="w-full h-full object-cover" loading="lazy" />
          </div>
        </div>
      </section>
      ...
      <section className="container-narrow py-20 md:py-28 grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        <div className="image-polish relative aspect-[4/5] rounded-2xl overflow-hidden md:order-1 order-2 bg-sand">
          <SafeImage src={campsiteRiverside.url} alt="Ewaso Nyiro river sunset near Umoja Campsite" className="w-full h-full object-cover" loading="lazy" />
        </div>
        <div className="md:order-2 order-1">
          ...
          <Link to="/campsite" className="inline-flex items-center gap-2 text-primary font-medium border-b border-primary/40 pb-1 hover:border-primary">
            Explore Umoja Campsite <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </section>
      ...
      <section className="image-fill-polish-wrap relative overflow-hidden bg-charcoal">
        <SafeImage src={beadwork.url} alt="Samburu woman with intricate beadwork seated by a craft stall" className="image-fill-polish w-full h-[60vh] md:h-[80vh] object-cover object-[45%_center] md:object-[68%_center]" loading="lazy" />
      ...
      <section className="container-narrow pb-24">
        <div className="rounded-3xl bg-charcoal text-cream p-10 md:p-16 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-4 text-cream/75 text-lg">Stay at Umoja Campsite, learn from the women, and walk away with a story worth keeping.</p>
          </div>
          <div className="flex flex-wrap gap-3 md:justify-end">
            <Link to="/contact" className="inline-flex min-h-11 w-full sm:w-auto items-center justify-center gap-2 bg-ochre text-charcoal px-7 py-3.5 rounded-full font-medium hover:opacity-90">
              Send an enquiry <ArrowRight className="w-4 h-4" />
            </Link>
            <Link to="/support" className="inline-flex min-h-11 w-full sm:w-auto items-center justify-center gap-2 border border-cream/40 px-7 py-3.5 rounded-full hover:bg-cream/10">
              Support the work
            </Link>
          </div>
        </div>
